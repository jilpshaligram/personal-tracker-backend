...
import { Transaction as TransactionModel } from '@/modules/transactions/transaction.schema';
import { CreateBillDto } from '@/modules/bills/dto/create-bill.dto';
import { UpdateBillDto } from '@/modules/bills/dto/update-bill.dto';
import { PayBillDto } from '@/modules/bills/dto/pay-bill.dto';
import { BillFilterDto } from '@/modules/bills/dto/bill-filter.dto';
import { BillResponseDto } from '@/modules/bills/dto/bill-response.dto';
import { BillMapper } from '@/modules/bills/mapper/bill.mapper';
...
import { PaymentMethod as TxPaymentMethod } from '@/modules/transactions/enums/payment-method.enum';
...
export class BillService {
  ...
  async findAll(
    ...
    if (dueFrom || dueTo) {
      const dueDateFilter: Record<symbol, unknown> = {};
